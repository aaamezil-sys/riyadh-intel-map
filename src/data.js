...
export const PROJECTS = [
  ...
  {id:31,sector:"hospitality",name:"Rua Al Madinah",lat:24.4670,lng:39.6109,value:"$20B+",gdp:"$37.25B by 2030",jobs:"93,000",status:"Under Construction",completion:"2030",phase:"Phase 1 — 60% infra complete",contractor:"Rua Al Madinah Holding (PIF)",description:"1.5M sqm development near the Prophet's Mosque adding 47,000 hotel rooms for 30M Umrah pilgrims annually.",image:"https://images.unsplash.com/photo-1591604129939-f1efa4d9f7fa?w=800&q=80",link:"https://www.ruaalmadinah.com"},
  {id:32,sector:"energy",name:"King Salman Automotive Cluster — KAEC",lat:22.4487,lng:39.1336,value:"$5B+",gdp:"$24.5B by 2035",jobs:"30,000+",status:"Under Construction",completion:"2026",phase:"Factory Construction",contractor:"Ceer (PIF + Foxconn) + Lucid Motors + Hyundai",description:"Saudi Arabia's first automotive manufacturing hub with Ceer EV plant (240K vehicles/yr) and Lucid factory.",image:"https://images.unsplash.com/photo-1593941707882-a5bba14938c7?w=800&q=80",link:"https://ceermotors.com"},
  {id:33,sector:"hospitality",name:"The Rig — Offshore Adventure Platform",lat:26.80,lng:50.05,value:"$5B",gdp:"$3.5B+",jobs:"10,000+",status:"Under Construction",completion:"2027",phase:"Construction RFPs Awarded",contractor:"Oil Park Development Company (PIF)",description:"World's first offshore tourism destination on decommissioned oil platforms with 800 rooms and 70 attractions.",image:"https://images.unsplash.com/photo-1518623489648-a173ef7824f3?w=800&q=80",link:"https://therig.sa"},
  {id:34,sector:"sports",name:"Aramco Stadium — Al Khobar",lat:26.3300,lng:50.2100,value:"$1B",gdp:"$2B+",jobs:"15,000+",status:"Under Construction",completion:"2027",phase:"Active Construction",contractor:"BESIX + Al Bawani",description:"46,000-seat FIFA 2034 World Cup and AFC Asian Cup 2027 venue on Al Khobar's Corniche.",image:"https://images.unsplash.com/photo-1577223625816-7546f13df25d?w=800&q=80",link:"https://www.aramcostadium.com"},
  {id:35,sector:"culture",name:"Jeddah Historic District (Al-Balad)",lat:21.4225,lng:39.8262,value:"$2.5B",gdp:"$4B",jobs:"15,000",status:"Planning",completion:"2029",phase:"Master Planning",contractor:"Ministry of Culture + PIF",description:"UNESCO-backed Al-Balad heritage zone restoration with museums, galleries, and creative industries hub.",image:"https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&q=80",link:"https://www.moc.gov.sa"},
  {id:36,sector:"transport",name:"Jeddah Rapid Transit",lat:21.5433,lng:39.1728,value:"$5.5B",gdp:"$9B",jobs:"42,000",status:"Under Construction",completion:"2029",phase:"Phase 1 — BRT Lines",contractor:"Jeddah Transit Authority",description:"Three-phase BRT and metro system for 1.2M daily riders.",image:"https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=800&q=80",link:"https://www.jeddah.gov.sa"},
  {id:37,sector:"energy",name:"NEOM Oxagon DataVolt AI Factory",lat:27.9833,lng:35.2000,value:"$5B",gdp:"$8B+",jobs:"5,000+",status:"Planning",completion:"2028",phase:"Agreement Signed Feb 2025",contractor:"DataVolt + NEOM Company",description:"1.5GW net-zero hyperscale AI data center in Oxagon powered entirely by renewable energy.",image:"https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=800&q=80",link:"https://www.neom.com/en-us/regions/oxagon"},
];

export const FEED = [
  {label:"Total Vision 2030 Pipeline",val:"<span>$2.14T+</span> across 37 tracked projects"},
